...
#else
    #error "No synch implementation defined"
#endif
...
#if defined(SLL)
cdsl_sll                 *qHead;
typedef iterator_cdsl_sll iterator;
#elif defined(DLL)
cdsl_dll                 *qHead;
typedef iterator_cdsl_dll iterator;
#elif defined(DYN_ARR)
cdsl_dyn_array                 *qHead;
typedef iterator_cdsl_dyn_array iterator;
#endif
...
{
    iterator it = qHead->iter_begin(qHead);
